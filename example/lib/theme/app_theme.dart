...
class AppTheme {
  ...
  static const TextTheme _textThemeSmall = TextTheme(
    displayLarge: TextStyle(
        fontSize: 102.0, fontWeight: FontWeight.w300, letterSpacing: -3.5),
    displayMedium: TextStyle(
        fontSize: 92.0, fontWeight: FontWeight.w300, letterSpacing: -2.5),
  ...
  static const TextTheme _textThemeRegular = TextTheme(
    displayLarge: TextStyle(
        fontSize: 114.0, fontWeight: FontWeight.w300, letterSpacing: -3.5),
    displayMedium: TextStyle(
        fontSize: 106.0, fontWeight: FontWeight.w300, letterSpacing: -2.5),
    displaySmall: TextStyle(
  ...
  static const TextTheme _textThemeLarge = TextTheme(
    displayLarge: TextStyle(
        fontSize: 122.0, fontWeight: FontWeight.w300, letterSpacing: -4.5),
    displayMedium: TextStyle(
        fontSize: 114.0, fontWeight: FontWeight.w300, letterSpacing: -3.5),
    displaySmall: TextStyle(
        fontSize: 112.0, fontWeight: FontWeight.w300, letterSpacing: -2.5),
    headlineLarge: TextStyle(
